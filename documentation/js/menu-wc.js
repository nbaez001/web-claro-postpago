...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">webapp-scriptportlettvpostpago-angular documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-fb04c4f70d5940a25c56a94b82fee0b8"' : 'data-target="#xs-components-links-module-AppModule-fb04c4f70d5940a25c56a94b82fee0b8"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-fb04c4f70d5940a25c56a94b82fee0b8"' :
                                            'id="xs-components-links-module-AppModule-fb04c4f70d5940a25c56a94b82fee0b8"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/DeviceListModel.html" data-type="entity-link">DeviceListModel</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/DevicePrice.html" data-type="entity-link">DevicePrice</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/FilterListModel.html" data-type="entity-link">FilterListModel</a>
                            </li>
                            <li class="link">
